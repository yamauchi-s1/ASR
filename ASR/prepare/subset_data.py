...
if __name__ == "__main__":
    ...
    # 全データが記述されているリストの置き場
    all_dir = './ASR/data/label/all/'

    # 評価データが記述されたリストの出力先
    out_eval_dir = './ASR/data/label/test'
    # 開発データが記述されたリストの出力先
    out_dev_dir = './ASR/data/label/dev'
    # 学習データ（小）が記述されたリストの出力先
    out_train_small_dir = './ASR/data/label/train_small'
    # 学習データ（大）が記述されたリストの出力先
    out_train_large_dir = './ASR/data/label/train_large'
